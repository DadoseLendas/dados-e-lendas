        ...
        return (
            <div className="w-full space-y-1.5">
                <div className="flex justify-between items-center text-[11px] sm:text-[12px] font-black uppercase tracking-widest text-[#4a5a4a]">
                    ...
                    <span className="text-[#f1e5ac]">{current} / {max}</span>
                </div>
                <div className="relative w-full h-4 bg-black border border-[#1a2a1a] rounded-full overflow-hidden shadow-[inset_0_0_12px_rgba(0,0,0,0.55)]">
                    <div className={`absolute inset-y-0 left-0 ${color} transition-all duration-500`} style={{ width: `${pct}%` }} />
                    <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(255,255,255,0.08)_0%,rgba(255,255,255,0)_18%,rgba(255,255,255,0)_82%,rgba(255,255,255,0.05)_100%)]" />
                </div>
            </div>
        );
    };
